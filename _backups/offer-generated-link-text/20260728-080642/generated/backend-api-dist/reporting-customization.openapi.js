export const COMPANY_OPERATIONS_OPENAPI_TAGS = Object.freeze([
    ...
    {
        name: 'Proxy',
        description: 'Encrypted company proxy, VPN, and Tor detection configuration.',
    },
    {
        name: 'SMTP',
    ...
    CompanyProxyConfigurationInput: {
        ...
        properties: {
            ...
            apiKey: {
                ...
                maxLength: 4096,
                writeOnly: true,
                description: 'Required when creating the configuration or changing the provider. Never returned by the API.',
            },
            status: {
                type: 'string',
                enum: [
...
export const COMPANY_OPERATIONS_OPENAPI_PATHS = Object.freeze({
    ...
    '/companies/{companyId}/proxy': {
        get: {
            tags: ['Proxy'],
            summary: 'Get the redacted company proxy detection configuration.',
            security: companySecurity,
            parameters: [
                companyIdParameter,
            ],
            responses: {
                200: {
                    description: 'Redacted proxy detection configuration.',
                    content: {
                        'application/json': {
                            schema: {
                                type: 'object',
                                properties: {
                                    data: {
                                        ...
                                        properties: {
                                            proxyConfiguration: {
                                                $ref: '#/components/schemas/CompanyProxyConfiguration',
                                            },
                                        },
                                    },
                                },
        ...
        put: {
            tags: ['Proxy'],
            summary: 'Create or update encrypted company proxy detection configuration.',
            security: companySecurity,
            parameters: [
                companyIdParameter,
            ],
            requestBody: {
                ...
                content: {
                    'application/json': {
                        schema: {
                            $ref: '#/components/schemas/CompanyProxyConfigurationInput',
                        },
                    },
                },
            },
            responses: {
                200: {
                    description: 'Updated redacted proxy detection configuration.',
                },
                400: {
...
//# sourceMappingURL=reporting-customization.openapi.js.map