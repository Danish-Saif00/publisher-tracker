import { CATALOG_OPERATIONS_OPENAPI_PATHS, CATALOG_OPERATIONS_OPENAPI_SCHEMAS, CATALOG_OPERATIONS_OPENAPI_TAGS, } from './catalog-operations.openapi.js';
import { OPENAPI_RECONCILIATION_PATHS, } from './openapi.reconciliation.js';
import { FINAL_OPERATIONS_OPENAPI_PATHS, FINAL_OPERATIONS_OPENAPI_SCHEMAS, FINAL_OPERATIONS_OPENAPI_TAGS, } from './final-operations.openapi.js';
import { COMPANY_INVITATIONS_OPENAPI_PATHS, COMPANY_INVITATIONS_OPENAPI_SCHEMAS, COMPANY_INVITATIONS_OPENAPI_TAGS, } from './company-invitations.openapi.js';
import { COMPANY_OPERATIONS_OPENAPI_PATHS, COMPANY_OPERATIONS_OPENAPI_SCHEMAS, COMPANY_OPERATIONS_OPENAPI_TAGS, } from './reporting-customization.openapi.js';
import { CONVERSION_POSTBACK_OPENAPI_PATHS, CONVERSION_POSTBACK_OPENAPI_SCHEMAS, CONVERSION_POSTBACK_OPENAPI_TAGS, } from './conversion-postbacks.openapi.js';
...
export function createOpenApiDocument(basePathValue) {
    ...
    return Object.freeze({
        ...
        info: {
            ...
            version: '0.1.0',
            description: 'Administrative API for multi-company affiliate tracking, attribution, duplicate protection, and fraud review.',
        },
        servers: [
            {
                url: basePath,
