...
function createListOperation(tag, summary, extraParameters = []) {
    return Object.freeze({
        tags: [tag],
        summary,
        security: bearerSecurity,
        parameters: [companyIdParameter, ...genericQueryParameters, ...extraParameters],
        responses: {
            '200': {
...
export const FINAL_OPERATIONS_OPENAPI_TAGS = Object.freeze([
    {
        ...
        description: 'Tenant performance reporting by network, offer, and publisher. Publisher access is restricted to the authenticated Publisher Offer dimension.',
    },
    {
...
export const FINAL_OPERATIONS_OPENAPI_PATHS = Object.freeze({
    '/companies/{companyId}/reports/{dimension}': {
        get: {
            ...createListOperation('Performance Reports', 'List performance report rows.', [
                dimensionParameter,
                {
                    in: 'query',
    ...
    '/companies/{companyId}/logs/clicks': {
        get: createListOperation('Operational Logs', 'List click log rows.', [
            {
                in: 'query',
                name: 'status',
                schema: {
    ...
    '/companies/{companyId}/logs/conversions': {
        get: createListOperation('Operational Logs', 'List conversion log rows.', [
            {
                in: 'query',
                name: 'status',
                schema: {
    ...
    '/companies/{companyId}/logs/sessions': {
        get: createListOperation('Operational Logs', 'List visitor sessions derived from captured clicks.'),
    },
    '/companies/{companyId}/logs/user-agents': {
        get: createListOperation('Operational Logs', 'List user-agent aggregates.', [
            {
                in: 'query',
                name: 'status',
                schema: {
...
//# sourceMappingURL=final-operations.openapi.js.map