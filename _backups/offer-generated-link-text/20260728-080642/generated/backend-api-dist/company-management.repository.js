...
export function createCompanyManagementRepository(database) {
    return Object.freeze({
        async createCompany(context, input) {
        ...
        async listAccessibleCompanies(context, userId) {
            return database.transaction(async (transaction) => {
                const result = await transaction.query({
        ...
        async getMembership(context, companyId, membershipId) {
            return database.transaction(async (transaction) => {
                const result = await transaction.query({
        ...
        async listMemberships(context, companyId) {
            return database.transaction(async (transaction) => {
                const result = await transaction.query({
        ...
        async inviteMembership(context, companyId, input) {
            return database.transaction(async (transaction) => {
                const result = await transaction.query({
        ...
        async updateMembership(context, companyId, membershipId, input) {
            return database.transaction(async (transaction) => {
                const result = await transaction.query({
...
//# sourceMappingURL=company-management.repository.js.map