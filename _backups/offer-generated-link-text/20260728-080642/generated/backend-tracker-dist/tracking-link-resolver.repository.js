...
function mapCapturedTrackingClickRow(row) {
...
export function createTrackingLinkResolverRepository(database) {
    return Object.freeze({
        async captureTrackingClick(input) {
            return database.transaction(async (transaction) => {
                const usesReferenceRoute = input.publisherPublicId !== undefined && input.offerPublicId !== undefined;
...
//# sourceMappingURL=tracking-link-resolver.repository.js.map