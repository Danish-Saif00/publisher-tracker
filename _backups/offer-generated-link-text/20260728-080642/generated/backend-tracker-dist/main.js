...
function combineShutdownErrors(currentError, nextError) {
    ...
    return new AggregateError([currentError, nextError], 'Multiple tracker resources failed to close cleanly.');
}
async function bootstrap() {
    ...
    try {
        ...
        const trackingLinkResolverService = createTrackingLinkResolverService(trackingLinkResolverRepository, visitorIdentityService, {
