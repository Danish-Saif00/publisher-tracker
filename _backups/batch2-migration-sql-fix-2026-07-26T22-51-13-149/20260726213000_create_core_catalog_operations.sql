...
create or replace function private.catalog_country_codes_valid(values text[])
returns boolean
language sql
immutable
...
create or replace function private.catalog_text_array_unique(values text[])
returns boolean
language sql
immutable
set search_path = pg_catalog
...
create or replace function private.catalog_smallint_array_unique(values smallint[])
returns boolean
language sql
immutable
set search_path = pg_catalog
