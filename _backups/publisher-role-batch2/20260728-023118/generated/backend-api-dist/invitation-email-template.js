...
function normalizeRequiredText(value, fieldName, maximumLength) {
    ...
    if (normalizedValue.length === 0 ||
        ...
        throw new Error(`${fieldName} must contain between 1 and ${String(maximumLength)} characters.`);
    }
...
export function renderCompanyInvitationEmail(input) {
    const companyName = normalizeRequiredText(input.companyName, 'Company name', 160);
    const actionLink = normalizeRequiredText(input.actionLink, 'Invitation action link', 8_192);
...
//# sourceMappingURL=invitation-email-template.js.map