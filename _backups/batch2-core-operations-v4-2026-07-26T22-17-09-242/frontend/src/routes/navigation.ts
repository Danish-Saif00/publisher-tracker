...
export const navigationGroups: readonly NavigationGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Companies', path: '/companies', icon: 'business', audience: 'platform-admin' },
      {
        ...
        path: '/billing',
        icon: 'payments',
        audience: 'company-admin-or-platform',
      },
      {
      ...
      { label: 'Tracking Domains', path: '/tracking-domains', icon: 'dns', audience: 'operations-team' },
      { label: 'Network Providers', path: '/network-providers', icon: 'hub', audience: 'platform-admin' },
      { label: 'Network Accounts', path: '/network-accounts', icon: 'account_tree', audience: 'operations-team' },
    ],
  },
  {
    label: 'Attribution',
    items: [
      { label: 'Offers', path: '/offers', icon: 'local_offer', audience: 'company-member' },
      ...
      { label: 'Conversions', path: '/conversions', icon: 'sync_alt', audience: 'company-member' },
      ...
      { label: 'Reports', path: '/reports', icon: 'analytics', audience: 'company-member' },
