...
export interface CompanyCustomizationRecord {
  ...
  readonly restrictedSharePlatforms:
    readonly CompanyRestrictedSharePlatform[];
  readonly defaultLinkQueryParameters:
...
export interface CompanyProxySecretRecord
  extends CompanyProxyConfigurationRecord {
