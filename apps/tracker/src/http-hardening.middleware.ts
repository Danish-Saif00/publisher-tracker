...
export interface CreateTrackerRateLimitMiddlewareOptions {
  readonly maxRequests: number;
  readonly skipPaths?: readonly string[];
  readonly windowMs: number;
}

export interface CreateTrackerSecurityHeadersMiddlewareOptions {
...
export function createTrackerRateLimitMiddleware(
  options: CreateTrackerRateLimitMiddlewareOptions,
): RequestHandler {
...
export function createTrackerSecurityHeadersMiddleware(
  options: CreateTrackerSecurityHeadersMiddlewareOptions,
): RequestHandler {
